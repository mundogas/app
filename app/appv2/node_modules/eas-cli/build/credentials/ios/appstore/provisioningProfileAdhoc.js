...
async function manageAdHocProfilesAsync(context, { udids, bundleId, certSerialNumber, profileId, }) {
    ...
    if (existingProfile) {
        ...
        let deviceUdidsInProfile = (_d = (_c = (_b = (_a = existingProfile === null || existingProfile === void 0 ? void 0 : existingProfile.attributes) === null || _a === void 0 ? void 0 : _a.devices) === null || _b === void 0 ? void 0 : _b.map) === null || _c === void 0 ? void 0 : _c.call(_b, i => i.attributes.udid)) !== null && _d !== void 0 ? _d : [];
        ...
        if (hasEqualUdids && existingProfile.isValid()) {
            const result = {
                profileName: (_e = existingProfile === null || existingProfile === void 0 ? void 0 : existingProfile.attributes) === null || _e === void 0 ? void 0 : _e.name,
                provisioningProfileId: existingProfile === null || existingProfile === void 0 ? void 0 : existingProfile.id,
                provisioningProfile: existingProfile === null || existingProfile === void 0 ? void 0 : existingProfile.attributes.profileContent,
            };
            if (didUpdate) {
