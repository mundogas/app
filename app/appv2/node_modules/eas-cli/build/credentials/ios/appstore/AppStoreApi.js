...
class AppStoreApi {
    ...
    async useExistingProvisioningProfileAsync(bundleIdentifier, provisioningProfile, distCert, profileClass) {
        const ctx = await this.ensureAuthenticatedAsync();
        return await (0, provisioningProfile_1.useExistingProvisioningProfileAsync)(ctx, bundleIdentifier, provisioningProfile, distCert, profileClass);
    }
