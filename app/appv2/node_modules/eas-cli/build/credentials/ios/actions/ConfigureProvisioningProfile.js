...
class ConfigureProvisioningProfile {
    ...
    async runAsync(ctx) {
        ...
        const profilesFromApple = await ctx.appStore.listProvisioningProfilesAsync(this.app.bundleIdentifier);
    ...
    async configureAndUpdateAsync(ctx, authCtx, app, profileFromApple) {
        ...
        const updatedProfile = await ctx.appStore.useExistingProvisioningProfileAsync(app.bundleIdentifier, profileFromApple, {
            certId: developerPortalIdentifier !== null && developerPortalIdentifier !== void 0 ? developerPortalIdentifier : undefined,
