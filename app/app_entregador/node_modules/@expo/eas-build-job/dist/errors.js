...
class UnknownError extends UserError {
    constructor() {
        ...
        this.message = 'Unknown error. Please see logs.';
    }
}
...
class UnknownFastlaneError extends UserError {
    constructor() {
        ...
        this.message = `Fastlane build failed with unknown error. Please refer to the "Run fastlane" and "Xcode Logs" phases.
...
class UnknownGradleError extends UserError {
    constructor() {
        ...
        this.message = 'Gradle build failed with unknown error. Please see logs for the "Run gradlew" phase.';
    }
}
