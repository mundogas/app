...
function printSubmissionDetailsUrls(submissions) {
    if (submissions.length === 1) {
        ...
        log_1.default.log(`Submission details: ${chalk_1.default.underline(getSubmissionDetailsUrl(submission))}`);
    }
    else {
        submissions.forEach(submission => {
            log_1.default.log(`${platform_1.appPlatformDisplayNames[submission.platform]} submission details: ${chalk_1.default.underline(getSubmissionDetailsUrl(submission))}`);
        });
    }
}
