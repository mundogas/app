...
})(SelectAndroidBuildCredentialsResultType = exports.SelectAndroidBuildCredentialsResultType || (exports.SelectAndroidBuildCredentialsResultType = {}));
/**
...
class SelectAndroidBuildCredentials {
    ...
    async runAsync(ctx) {
        ...
        return {
            resultType: SelectAndroidBuildCredentialsResultType.CREATE_REQUEST,
            result: {
                isDefault: !defaultCredentialsExists,
                name: await (0, BuildCredentialsUtils_1.promptForNameAsync)(),
            },
        };
    }
