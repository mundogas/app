...
async function selectPushKeysAsync(pushKeys, validPushKeys) {
    const validPushKeyIdentifiers = validPushKeys === null || validPushKeys === void 0 ? void 0 : validPushKeys.map(pushKey => pushKey.keyIdentifier);
...
function sortPushKeys(pushKeys, validPushKeys) {
    ...
    return pushKeys.sort((pushKeyA, pushKeyB) => {
        if (validPushKeyIdentifiers === null || validPushKeyIdentifiers === void 0 ? void 0 : validPushKeyIdentifiers.includes(pushKeyA.keyIdentifier)) {
            return -1;
        }
        else if (validPushKeyIdentifiers === null || validPushKeyIdentifiers === void 0 ? void 0 : validPushKeyIdentifiers.includes(pushKeyB.keyIdentifier)) {
            return 1;
        }
        return 0;
    });
...
function formatPushKey(pushKey, validPushKeyIdentifiers) {
    ...
    line += ` ${appleTeam ? `, ${(0, AppleTeamUtils_1.formatAppleTeam)(appleTeam)}` : ''}`;
