...
async function updateAndroidCredentialsAsync(ctx, buildCredentials) {
    ...
    const androidCredentials = {
        keystore: {
            ...
            keyPassword: (_e = keystore.keyPassword) !== null && _e !== void 0 ? _e : undefined,
        },
    };
...
function createTargetCredentialsPathsMap(targets, rawCredentialsJsonMap) {
    ...
    for (const target of targets) {
        const rawTargetCredentialsJson = rawCredentialsJsonMap === null || rawCredentialsJsonMap === void 0 ? void 0 : rawCredentialsJsonMap[target.targetName];
        const filePrefix = hasManyTargets ? `${target.targetName}-` : '';
        paths[target.targetName] = {
            provisioningProfilePath: (_a = rawTargetCredentialsJson === null || rawTargetCredentialsJson === void 0 ? void 0 : rawTargetCredentialsJson.provisioningProfilePath) !== null && _a !== void 0 ? _a : `credentials/ios/${filePrefix}profile.mobileprovision`,
            distCertPath: (_c = (_b = rawTargetCredentialsJson === null || rawTargetCredentialsJson === void 0 ? void 0 : rawTargetCredentialsJson.distributionCertificate) === null || _b === void 0 ? void 0 : _b.path) !== null && _c !== void 0 ? _c : `credentials/ios/${filePrefix}dist-cert.p12`,
        };
    }
...
async function getTargetBuildCredentialsAsync(ctx, app, target, iosDistributionType) {
    ...
    const appBuildCredentials = (_a = appCredentials === null || appCredentials === void 0 ? void 0 : appCredentials.iosAppBuildCredentialsList.find(appBuildCredentials => appBuildCredentials.iosDistributionType === iosDistributionType)) !== null && _a !== void 0 ? _a : null;
    if (appBuildCredentials === null) {
        return null;
    }
    if (!(((_b = appBuildCredentials.provisioningProfile) === null || _b === void 0 ? void 0 : _b.provisioningProfile) !== undefined &&
        ((_c = appBuildCredentials.distributionCertificate) === null || _c === void 0 ? void 0 : _c.certificateP12) !== undefined &&
        ((_d = appBuildCredentials.distributionCertificate) === null || _d === void 0 ? void 0 : _d.certificatePassword) !== undefined)) {
        return null;
    }
    return {
