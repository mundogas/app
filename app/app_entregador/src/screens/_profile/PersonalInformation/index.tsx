...
export function PersonalInformation() {
	...
	async function handleEditProfile(){
		...
		api.put('entregador/editar-perfil/' +user?.id, updateProfile).then((res: any) => {
			updateUser(Number(res.data.data.id), res.data.data.name, res.data.data.name_array, res.data.data.email);
