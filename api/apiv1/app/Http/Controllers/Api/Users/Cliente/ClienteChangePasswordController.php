...
class ClienteChangePasswordController extends Controller
{
    public function passwordResetProcess(ClientePasswordRequest $request){
      ...
      private function resetPassword($request) {
          // find email
          $userData = Cliente::whereEmail($request->email)->first();
