...
export class AdministradoresComponent implements OnInit {
  ...
  displayed = ['image', 'nome', 'email', 'criado', 'acoes'];
  ...
  post() {
    ...
    this.crudSrv.post('admins', this.dataForm.value).subscribe(
      res => {
  ...
  update(id: number){
    ...
    this.crudSrv.update('admins', id, this.updateForm.value).subscribe(
      res => {
